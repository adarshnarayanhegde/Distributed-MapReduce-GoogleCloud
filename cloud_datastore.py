...
lock=threading.Lock()
csv_file="/home/adarshhegdegef/datastore.csv"
...
# Creating a log file
logging.basicConfig(filename='/home/adarshhegdegef/datastore.log', filemode='w', level=logging.DEBUG, format='%(asctime)s - %(filename)s - %(levelname)s - %(message)s',datefmt='%Y-%m-%d %H:%M:%S')
...
class ProcessRequest:
    ...
    def runBackup(command):
        try:
            if(os.path.exists("/home/adarshhegdegef/datastore.csv")):
                lock.acquire()
                os.rename("/home/adarshhegdegef/datastore.csv","/home/adarshhegdegef/backup_datastore.csv")
                lock.release()
